// WinFFmpeg1221 is a .NET Framework console app project using Batch SDK for .NET.
// Demonstrates a basic Batch pool that processes ffmpeg as the task.

namespace WinFFmpeg1221
{
    using System;
    ...
    class Program
    {
        ...
        private const string BatchAccountName = "batchtest913";
        private const string BatchAccountKey = "qrK8EgN2vsR6SzBswFqbVPU5tMqIQ5x3O/4/JSRu9SdnK2XWKvH26KMoX+LHpYMVAsM8Xpieat+sczYrQ9Lv7g==";
        private const string BatchAccountUrl = "https://batchtest913.eastus.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "generalstorage925";
        private const string StorageAccountKey = "FbK3yVjeD0GyrXf5RTvfhUl4YKnO2FcJ79FZcoDMSHC7jLDqRE6slzZMhL/YSKI/R4zFgvw0jLwHKsELHEGCew==";

        // Pool and Job IDs
        private const string PoolId = "WinFFmpegPool1222a";
        private const string JobId = "WinFFmpegJob1222a";
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                const string inputContainerName = "input-1222a";
                const string outputContainerName = "output-1222a";
                ...
                using (BatchClient batchClient = BatchClient.Open(sharedKeyCredentials))
                {
                    ...
                    // %% OPTIONAL: WE MIGHT NOT NEED TO DOWNLOAD FILES TO LOCAL DIR
        ...
        // %% OPTIONAL: WE MIGHT NOT NEED THIS METHOD
